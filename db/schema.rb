...
ActiveRecord::Schema.define(:version => 20110708045901) do
  ...
  create_table "employees", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "emp_photo_file_name"
    t.string   "emp_photo_content_type"
    t.integer  "emp_photo_file_size"
    t.datetime "emp_photo_updated_at"
  end
  ...
  create_table "students", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "stuphoto_file_name"
    t.string   "stuphoto_content_type"
    t.integer  "stuphoto_file_size"
    t.datetime "stuphoto_updated_at"
  end
